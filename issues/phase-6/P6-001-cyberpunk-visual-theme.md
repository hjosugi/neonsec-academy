...
- [x] color tokens, glow, grid background, panel border, status lights を実装する
- [x] Question / Review / Exam の可読性を最優先にする
- [x] glow intensity setting を持つ
- [x] design regression checklist を作る

## Acceptance Criteria

- [x] 主要画面が design system と一致する
- [x] low glow mode が動く
- [x] 長文問題の可読性が保たれる

## Subtasks

- [x] theme tokens を適用する
- [x] panel style を作る
- [x] status light を作る
- [x] visual QA を行う
